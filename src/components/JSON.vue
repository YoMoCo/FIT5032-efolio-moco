...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ol>
        <li v-for="author in authors">{{ author.name }} ({{ author.birthYear }})</li>
      </ol>
      ...
      modernAuthors
      <ol>
        <li v-for= "author in modernAuthors">{{ author.name }} ({{ author.birthYear }})</li>
      </ol>
...
const orwell = computed(() => {
  // CODE TO FIND AUTHOR BY NAME HERE
